...
output "service_binding_id" {
  value       = length(azurerm_role_assignment.service_binding) > 0 ? azurerm_role_assignment.service_binding[0].id : null
  description = "ID of the service principal role assignment"
}

output "user_binding_id" {
  value       = length(azurerm_role_assignment.user_binding) > 0 ? azurerm_role_assignment.user_binding[0].id : null
